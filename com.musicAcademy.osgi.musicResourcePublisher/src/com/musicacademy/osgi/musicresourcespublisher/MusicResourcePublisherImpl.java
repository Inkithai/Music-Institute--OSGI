...
public class MusicResourcePublisherImpl implements IMusicResourcePublisher {
	...
	public void addMusicalInstruments() {
		...
		try {
			...
			System.out.println("******All the Music instruments have added successsfully!******");
		}
		catch(Exception e){
			e.printStackTrace();		
		}
	...
	public void updateMusicItem(){
		...
		do {
		System.out.println("Enter the instrument model number you want to Update");
	...
	public void deleteMusicItem(){
		...
		do {
		System.out.println("Enter the instrument model numbe you want to remove");
		...
		System.out.println("\n\n************************************************************************");
		System.out.println("       Remaining instruments      ");
		System.out.println("************************************************************************");
		for(InstrumentModel inst:instrumentList) {
			this.displayInstrumentDetails(inst);
		}
